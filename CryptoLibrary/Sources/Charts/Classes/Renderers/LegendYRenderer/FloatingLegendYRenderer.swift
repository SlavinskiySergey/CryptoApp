...
public final class FloatingLegendYRenderer: UIView, LegendYRenderer {
    ...
    private lazy var fadeAnimator: AlphaAnimator = {
    ...
    public init(valuesCount: Int, showsTopValue: Bool) {
    ...
    public func chartWillTransition(to toIntervals: [IntervalY]) {
