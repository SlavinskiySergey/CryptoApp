...
public final class FloatingLegendXRenderer: UIView, LegendXRenderer {
    ...
    private lazy var timestampsFadeInAnimator: AlphaAnimator = {
        return AlphaAnimator() { newAlpha in
            if newAlpha >= 1 {
    ...
    private lazy var timestampsFadeOutAnimator: AlphaAnimator = {
        return AlphaAnimator() { newAlpha in
            if newAlpha <= 0.01 {
    ...
    public func setTimestamps(_ timestamps: [Timestamp]) {
