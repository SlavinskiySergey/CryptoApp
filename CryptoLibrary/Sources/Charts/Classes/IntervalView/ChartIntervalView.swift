...
public final class ChartIntervalView: UIView {
    public var onIntervalChange: ((Interval<CGFloat>) -> Void)?
    ...
    private lazy var controlPanRecognizer = UIPanGestureRecognizer(
        target: self,
